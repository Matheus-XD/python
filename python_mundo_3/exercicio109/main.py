...
print(f'A metade do preço {moedas.moeda(p)} é {moedas.metade(p)}')
print(f'O dobro do preço {moedas.moeda(p)} é {moedas.dobro(p)}')
print(f'Aumentado de 10%, temos {moedas.aumentar(p, 10)} ')
